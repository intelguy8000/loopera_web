...
export default function WhatsAppButton() {
  const phoneNumber = '573162888832'; // +57 (316) 288-8832
  const message = encodeURIComponent('Hola Santiago, me gustaría agendar una sesión exploratoria');
  ...
  return (
    ...
    >
      ...
      <span className="absolute -top-1 -right-1 w-3 h-3 bg-primary-red rounded-full animate-ping"></span>
